...
// ── CDN keš — namjerno KRATAK (15s, ne 60-180s kao ranije u /api/flights)
// jer ova ruta sad nosi i desk/gate status koji mora biti skoro real-time.
...
// osoblje nešto promijeni — s-maxage je samo fallback gornja granica.

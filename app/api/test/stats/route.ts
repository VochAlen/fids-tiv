...
// ── KRITIČNO: bez ovoga, GET() bez request parametra i bez dinamičkih
// API poziva (cookies/headers) Next.js može tretirati kao statičku rutu
// i zamrznuti odgovor preko svog internog Data Cache-a, nezavisno od
// Cache-Control headera i in-process cachedMeta keša ispod. ──────────
